...
// $trails_display1 = [];
if ($_GET['trails_display1']) {
    $trails_display1_sql = "UPDATE `trails` SET `trails_display`=? WHERE `sid`=?";
    $trails_display1 = $pdo->prepare($trails_display1_sql);
    $trails_display1->execute([
        $trails_display,
        $sid,
    ]);
}
